...
public class MainFrame extends javax.swing.JFrame {
    ...
    DefaultTableModel dtm; //Giúp lưu dữ liệu trong bảng Nhân Viên
    ...
    private void themNVButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_themNVButtonActionPerformed
        ...
        if(maNV.equals("") || tenNV.equals("") || gioiTinh.equals("") || phongBan.equals("")){
            ...
            dtm = (DefaultTableModel) NVTable.getModel();
            dtm.addRow(new Object[] {maNV, tenNV, namSinh, gioiTinh, phongBan}); //Thêm dữ liệu vào bảng
            NVTable.setModel(dtm);
            clearData();
        }

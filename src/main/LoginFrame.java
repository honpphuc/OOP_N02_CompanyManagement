...
public class LoginFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CHƯƠNG TRÌNH QUẢN LÝ CÔNG TY");
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        ...
        if(kiemTraDangNhap(username, password)){
            ...
            JOptionPane.showMessageDialog(rootPane, "Kiểm tra lại tên đăng nhập, mật khẩu");
        }
    ...
    //Mở giao diên chính sau khi đăng nhập thành công
